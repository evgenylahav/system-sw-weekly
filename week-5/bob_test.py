...
class BobTest(unittest.TestCase):
    ...
    def test_starting_with_please(self):
        self.assertEqual(hey("please, tell me what you think"), "mmm... OK")

    def test_yelling_with_please(self):
        self.assertEqual(hey("DO THAT PLEASE!!"), "mmm... OK")

    def test_yelling_question_with_please(self):
        self.assertEqual(hey("WILL YOU PLEASE MOVE?"), "mmm... OK")
    ...
    def test_yelling_bobs_name_with_question(self):
        self.assertEqual(hey("BOB, WILL YOU STOP IT?"), "Calm down, I know what I'm doing!")
